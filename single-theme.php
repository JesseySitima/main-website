...
if ($url == ("theme/maternal-neonatal-and-child-health-theme")) {
    header('Location: ' . bloginfo("url") . "/themes/maternal-health-about");
    return;
}
...
if (have_posts()): while (have_posts()): the_post();
        ...
        $hero_caption = get_field("hero_caption_");

        $theme_leads = get_field("theme_lead");
        $deputy = get_field("deputy");
	...
	<main id="main" class="site-main programme">
        ...
        if ($query->have_posts()): while ($query->have_posts()): $query->the_post();
                ...
                ?>
					...
					<a href="<?php the_permalink();?>" <?php if ($programme_number == $number): ?>class="current"
						<?php endif;?>>Theme <?php echo $count; ?></a>
...
if ($theme_leads):
    ...
    foreach ($theme_leads as $lead):

    ?>

					<div class="profile">

						<span class="title">Theme Lead</span>
...
?>
					...
					<div class="profile">
						...
						<span class="title">Deputy</span>

						<span class="name"><?php echo $deputy; ?></span>
...
?>
						...
						<div class="key">
							...
							<span class="text">Theme <?php echo $programme_number; ?> track record of excellence (blue
								rectangles) and prioritised research areas (yellow lozenges).</span>
