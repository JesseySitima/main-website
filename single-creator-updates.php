...
<div id="hero" class="single alternate alt1">
	...
	<div class="wrapper">
		...
		<div class="caption">
			...
			<span class="sub">Creator Updates</span>
	...
	<main id="main" class="site-main news single">
		...
		<div class="details">
			...
			<div class="container l0">
				...
				<aside class="left">
					...
					<a href="<?php bloginfo("url");?>/creator-updates/" class="backTo">

						<span class="arrow"></span>
						<span class="text">Back to Creator Updates</span>
		...
		<div class="related">
			...
			<div class="container l0">
	          ...
	          $creator_updates = new WP_Query($args);

	          if($creator_updates->have_posts()) : while($creator_updates->have_posts()) : $creator_updates->the_post();
